 ...
 public PlayerLogic playerLogic;
    ...
    private void Start()
    {
       ...
       // target = GameObject.FindGameObjectWithTag("Player");
        ...
        WarrokAudio = this.GetComponent<AudioSource>();
    }
    ...
    {
        WarrokAudio.clip = AttackSwingAudio;
        WarrokAudio.Play();
        if(DistancetoTarget <= agent.stoppingDistance)
        {
           WarrokAudio.clip = AttackConnectAudio;
           WarrokAudio.Play();
